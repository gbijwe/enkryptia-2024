...
class _HomePageState extends State<HomePage> {
  ...
  ValueNotifier<bool> isClockedIn = ValueNotifier<bool>(false);
  late Future<List<Map<String, dynamic>>> _assignments;
  // final Uri url = Uri.parse("https://www.google.com/maps/search/?api=1&query=$_assignments");
  ...
  Future<void> onLaunchURL(double latitude, double longitude) async {
                              ...
                              return Padding(
                                ...
                                child: PhysicalModel(
                                  ...
                                  child: ListTile(
                                    ...
                                    leading: endTime != null ? const Icon(Icons.check_circle_outline_sharp, color: Colors.green,) :
                                    ...
                                    IconButton(
                                      onPressed: () {
                                        onLaunchURL(assignment['lat'].toDouble(), assignment['long'].toDouble());
                                      },
                                    ...
                                    subtitle: endTime != null
                                      ...
                                      children: [
                                        Column(
                                          children: [
                                            Text(
                                              'Latitude: ${assignment['lat'].toDouble().toStringAsFixed(4)}', // 4 decimal places
                                              style: const TextStyle(fontSize: 14, color: Colors.grey),
                                            ),
                                            Text(
                                              'Longitude: ${assignment['long'].toDouble().toStringAsFixed(4)}', // 4 decimal places
                                              style: const TextStyle(fontSize: 14, color: Colors.grey),
                                            ),
                                          ],
                                        ),
