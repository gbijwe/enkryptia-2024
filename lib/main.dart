...
// import 'package:enkryptia/credentials.dart';
// import 'package:enkryptia/provider/shift_timer_provider.dart';
// import 'package:enkryptia/router/router.dart';
// import 'package:flutter/material.dart';
// import 'package:flutter_background_service/flutter_background_service.dart';
// import 'package:location/location.dart';
...
//     MultiProvider(
//       providers: [
//         ChangeNotifierProvider(create: (_) => ShiftTimerProvider()),
//       ],
//       child: const MainApp(),
//     ),
//   );
...
//   Timer.periodic(const Duration(seconds: 1), (timer) async {
//     final shiftTimerProvider = Provider.of<ShiftTimerProvider>(context, listen: false);
//     shiftTimerProvider.incrementTimer();
    
//     final prefs = await SharedPreferences.getInstance();
//     // prefs.setInt('shiftTimer', shiftTimerProvider.shiftTimer);

//     if (service is AndroidServiceInstance) {
//       if (await service.isForegroundService()) {
//         service.setForegroundNotificationInfo(
//           title: "Shift started!",
//           content: "Time on the clock: ${shiftTimerProvider.shiftTimer ~/ 3600}:${shiftTimerProvider.shiftTimer ~/ 60}:${(shiftTimerProvider.shiftTimer % 60).toString().padLeft(2, '0')}",
//         );
//       }
//     }
//   });
